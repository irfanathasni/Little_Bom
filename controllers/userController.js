...
module.exports = {
    getRegister, postRegister, getLogin, postLogin, logout, getShop, getProducts,
    ...
    createRazorPayOrder, verifyPayment, placeCodOrder, getOrders, getOrderDetail, cancelOrder, returnOrder, getOrderSuccess, clearCart
}